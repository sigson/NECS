...
namespace NECS.Extensions
{
    ...
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, System.Collections.IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        ...
        /// <summary>Copy dictionary contents to an array - shared implementation between ToArray and CopyTo.</summary>
        /// <remarks>Important: the caller must hold all locks in _locks before calling CopyToPairs.</remarks>
        private void CopyToEntries(System.Collections.DictionaryEntry[] array, int index)
        {
            Node?[] buckets = _tables._buckets;
            for (int i = 0; i < buckets.Length; i++)
            {
                for (Node? current = buckets[i]; current != null; current = current._next)
                {
                    array[index] = new System.Collections.DictionaryEntry(current._key, current._value);
        ...
        /// made to the dictionary after <see cref="GetEnumerator"/> was called.
        /// </remarks>
        System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => ((ConcurrentDictionary<TKey, TValue>)this).GetEnumerator();
        ...
        System.Collections.IDictionaryEnumerator System.Collections.IDictionary.GetEnumerator() => new DictionaryEnumerator(this);
        ...
        System.Collections.ICollection System.Collections.IDictionary.Keys => GetKeys();
        ...
        /// cref="IDictionary"/>.</value>
        System.Collections.ICollection System.Collections.IDictionary.Values => GetValues();
        ...
        void System.Collections.ICollection.CopyTo(Array array, int index)
        {
            ...
            try
            {
                ...
                if (array is System.Collections.DictionaryEntry[] entries)
                {
        ...
        object System.Collections.ICollection.SyncRoot => throw new NotSupportedException(SR.ConcurrentCollection_SyncRoot_NotSupported);
        ...
        /// </summary>
        private sealed class DictionaryEnumerator : System.Collections.IDictionaryEnumerator
        {
            ...
            public System.Collections.DictionaryEntry Entry => new System.Collections.DictionaryEntry(_enumerator.Current.Key, _enumerator.Current.Value);
    ...
    {
        internal static void ThrowArgumentNullException(string v, object concurrentDictionary_ItemKeyIsNull)
        {
            throw new NotImplementedException();
        }

        internal static void ThrowArgumentNullException(string v)
        {
            throw new NotImplementedException();
        }
    ...
    internal sealed class CDSCollectionETWBCLProvider : System.Diagnostics.Tracing.EventSource
    {
        ...
        private const System.Diagnostics.Tracing.EventKeywords ALL_KEYWORDS = (System.Diagnostics.Tracing.EventKeywords)(-1);
        ...
        [System.Diagnostics.Tracing.Event(CONCURRENTSTACK_FASTPUSHFAILED_ID, Level = System.Diagnostics.Tracing.EventLevel.Warning)]
        public void ConcurrentStack_FastPushFailed(int spinCount)
        {
            if (IsEnabled(System.Diagnostics.Tracing.EventLevel.Warning, ALL_KEYWORDS))
            {
                WriteEvent(CONCURRENTSTACK_FASTPUSHFAILED_ID, spinCount);
            }
        }

        [System.Diagnostics.Tracing.Event(CONCURRENTSTACK_FASTPOPFAILED_ID, Level = System.Diagnostics.Tracing.EventLevel.Warning)]
        ...
        [System.Diagnostics.Tracing.Event(CONCURRENTDICTIONARY_ACQUIRINGALLLOCKS_ID, Level = System.Diagnostics.Tracing.EventLevel.Warning)]
        ...
        [System.Diagnostics.Tracing.Event(CONCURRENTBAG_TRYTAKESTEALS_ID, Level = System.Diagnostics.Tracing.EventLevel.Verbose)]
        public void ConcurrentBag_TryTakeSteals()
        {
            if (IsEnabled(System.Diagnostics.Tracing.EventLevel.Verbose, ALL_KEYWORDS))
            {
                WriteEvent(CONCURRENTBAG_TRYTAKESTEALS_ID);
            }
        }

        [System.Diagnostics.Tracing.Event(CONCURRENTBAG_TRYPEEKSTEALS_ID, Level = System.Diagnostics.Tracing.EventLevel.Verbose)]
    ...
    public class SR
    {
        public static string Arg_HTCapacityOverflow { get; internal set; }
        public static string ConcurrentCollection_SyncRoot_NotSupported { get; internal set; }
        public static string ConcurrentDictionary_ArrayIncorrectType { get; internal set; }
        public static string ConcurrentDictionary_ArrayNotLargeEnough { get; internal set; }
        public static string ConcurrentDictionary_IndexIsNegative { get; internal set; }
        public static string ConcurrentDictionary_TypeOfKeyIncorrect { get; internal set; }
        public static string ConcurrentDictionary_SourceContainsDuplicateKeys { get; internal set; }
        public static string ConcurrentDictionary_ConcurrencyLevelMustBePositive { get; internal set; }
        public static string ConcurrentDictionary_CapacityMustNotBeNegative { get; internal set; }
        public static string ConcurrentDictionary_ItemKeyIsNull { get; internal set; }
        public static object Arg_KeyNotFoundWithKey { get; internal set; }
        public static string? ConcurrentDictionary_KeyAlreadyExisted { get; internal set; }

        internal static string? Format(object arg_KeyNotFoundWithKey, string? v)
        {
            throw new NotImplementedException();
        }
    }
